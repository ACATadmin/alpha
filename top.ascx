<%@ control language="C#" autoeventwireup="true" inherits="top, afm_new" enableviewstate="false" %>
<script>
...
<div class="header">
	...
	<ul class="nav">
		...
		<li id="m_team"><a href="index.aspx#team">Team<span></span></a></li>
		<li><a href="faq.aspx">FAQ<span></span></a></li>
		<li><a target="_blank" href="Alphacat-WhitePaper_EN.pdf">Whitepaper<span></span></a></li>
		<div class="share">

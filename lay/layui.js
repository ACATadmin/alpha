...
!function (e) {
    ...
    o.prototype.cache = n, o.prototype.define = function (e, t) {
        ...
        return r && (t = e, e = []), layui["layui.all"] || !layui["layui.all"] && layui["layui.mobile"] ? a.call(o) : (o.use(e, a),
        o);
        ...
        var f = e[0], m = 0;
        if (l = l || [], n.host = n.host || (p.match(/\/\/([\s\S]+?)\//) || ["//" + location.host + "/"])[0],
        0 === e.length || layui["layui.all"] && u[f] || !layui["layui.all"] && layui["layui.mobile"] && u[f]) return c(),
        y;
        ...
        return u.rel = "stylesheet", u.href = e + (n.debug ? "?v=" + new Date().getTime() : ""),
        u.media = "all", t.getElementById(c) || l.appendChild(u), "function" != typeof o ? i : (function p() {
        ...
        return /^#\//.test(e) ? (n.href = e = e.replace(/^#\//, ""), e = e.replace(/([^#])(#.*$)/, "$1").split("/") || [],
        ...
        if (t = t || "layui", o = o || localStorage, e.JSON && e.JSON.parse) {
            ...
            return "value" in n && (r[n.key] = n.value), n.remove && delete r[n.key], o[t] = JSON.stringify(r),
            n.key ? r[n.key] : r;
        }
        ...
        return t && !r[t] && (r[t] = o(t)), r.android = /android/.test(n), r.ios = "ios" === r.os,
        r;

<%@ page language="C#" autoeventwireup="true" inherits="faq, afm_new" enableviewstate="false" enableviewstatemac="false" enableEventValidation="false" %>
...
<div class="faq">
	<div class="faq_main">
		<div class="faq_nav">
		<li <%=GetStyle("33") %>><a href="faq.aspx?cid=33">Platform</a></li>
		
			
			<li <%=GetStyle("34") %>><a href="faq.aspx?cid=34">Tokens</a></li>
			<li <%=GetStyle("35") %>><a href="faq.aspx?cid=35">General FAQ</a></li>
		</div><!-- faq_nav -->
